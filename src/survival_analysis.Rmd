...
data_type <- "exposures"
# Load data
tcga_ov <- read.csv(paste("/Users/yuexichen/Downloads/lrgr_file/mskfiles/sigma-wildtype-TCGA-OV-", id_type, "-survival-analysis-",  data_type, ".tsv", sep = ''),sep='\t')
# Specify data type: MSK, WXS or MSK-MSK
#new_binary_sig3 <- as.numeric(tcga_ov$exposure_sig3>0.5)
# Remove NAs
